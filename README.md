...
With Firebase configured, household page details, service history, home maintenance tasks, vehicle records, call/message links, and uploaded document links sync through Firebase.
